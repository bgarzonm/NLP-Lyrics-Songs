...
def write_lyrics_to_file(artist_name, song_count):
    with open('../lyrics/' + artist_name.lower() + '.txt', 'w', encoding='utf-8') as f:
        ...
        for url in urls:
            ...
            f.write(lyrics)
    num_lines = sum(1 for line in open('../lyrics/' + artist_name.lower() + '.txt', 'r', encoding='utf-8'))
...
lista = request_song_url(artista, 5)

scrape_song_lyrics('https://genius.com/Kendrick-lamar-humble-lyrics')

for i in lista:
    lyrics = scrape_song_lyrics(i)
    print(lyrics)
